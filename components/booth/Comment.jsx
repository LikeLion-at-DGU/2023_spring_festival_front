          ...
          {reply &&
            reply.map((reply) => (
              <ReplyWrapper key={reply.id}>
                ...
                />
                <CommentCardSecondRow key={reply.id}>
                  <ReplyFrist>
                    <NameDate>
                      {reply.writer}&nbsp;
                      {String(reply.created_at).split("T")[0]}&nbsp;
                      {String(reply.created_at).split("T")[1].slice(0, 5)}
                    </NameDate>
                    <ReplyDelete>
                  ...
                  <ReplySecond>{reply.content}</ReplySecond>
                </CommentCardSecondRow>
              </ReplyWrapper>
            ))}
        </>
      ...
      >
        <form onSubmit={handleDeleteModalConfirm}>
          <ModalDelWrapper>
            ...
            <ModalDelDes>댓글을 삭제하시겠습니까?</ModalDelDes>
            <ModalDelInput
              required
              type="password"
              placeholder="비밀번호"
            ...
            />
            <ModalDelBtnWrapper>
              <MdoalBtn onClick={handleDeleteModalClose}>뒤로가기</MdoalBtn>
              <MdoalBtn>제출하기</MdoalBtn>
            </ModalDelBtnWrapper>
          </ModalDelWrapper>
        </form>
      </Modal>
